#!/usr/bin/env python
"""Benchmark caveman vs normal Gemini output token counts."""
...
def main():
    parser = argparse.ArgumentParser(description="Benchmark caveman vs normal Gemini")
    ...
    parser.add_argument("--model", default="Gemini-sonnet-4-20250514", help="Model to use")
